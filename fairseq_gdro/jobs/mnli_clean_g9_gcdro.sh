...
exp_name=mnli_g9_clean_gcdro_seed${split}
...
python -u train.py ${DATA} \
    --reweight 0 --seed ${split} --num-train-groups 9 --num-test-groups 9 \
    --label-path ${DATA}/train.fg.labels --log-internal 0 \
...
python -u test.py ${DATA} \
    ...
    --criterion cross_entropy_group_dro \
    --dro-alpha 0.5 --beta-cover-instances 0.1 --ema 0.5 \
